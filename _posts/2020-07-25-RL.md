...
<br>
<br>
We saw 2 definitions of state. now here is a mathematical formulation to represent the state using markov states
### Markov state
...
Agent must construct its own state representation S<sup>a</sup><sub>t</sub>, e.g. 
...
<img src="{{ '/assets/img/maze_value_function.png' | prepend: site.baseurl }}" id="img_post">    
...
<img src="{{ '/assets/img/venn_diagram.png' | prepend: site.baseurl }}" id="img_post">
